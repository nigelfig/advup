    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('membership_type', models.CharField(choices=[('FREE', 'Free'), ('PROM', 'Professional Monthly'), ('PROA', 'Professional Annual')], default='FREE', max_length=30)),
                ('price', models.IntegerField(default=50)),
                ('stripe_plan_id', models.CharField(max_length=40)),
                ('plan_type', models.CharField(default='monthly', max_length=40)),
            ],
        ),
        migrations.CreateModel(
            name='UserMembership',
