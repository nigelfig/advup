...
$.ajax({
  ...
  success: function(data){
    months = data.months
    campaign_smss = data.campaign_smss
    sms_requests = data.requests
    sms_interactions = data.interactions

    var campsmsmon = document.getElementById("campsmsmon");
    campsmsmon.innerHTML = data.campaign_smss.slice(-1)[0]

    var reqmon = document.getElementById("reqmon");
    reqmon.innerHTML = data.requests.slice(-1)[0]

    var intermon = document.getElementById("intermon");
    intermon.innerHTML = data.interactions.slice(-1)[0]
...
function setChart(){
// Bar Chart #3
var ctx3 = document.getElementById("CampaignsBarChart");
